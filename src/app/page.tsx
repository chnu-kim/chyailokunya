      ...
      <div className="wrap">
        <div className="home__hero" data-od-id="home-hero">
          ...
          {/* 이름은 바로 아래 h1 이 말한다. 이 칩이 더할 게 있다면 "공식이 아니다" 뿐이다.
              그래서 잉크 채움(chip--ink)을 안 쓴다 — 채우면 선으로 그린 손글씨 제목 옆에서
              이 hero 의 유일한 꽉 찬 덩어리가 돼 부제가 제목보다 무거워진다. 외곽선은 배지
              형태를 남기고 무게만 뺀다(칩 껍데기까지 벗기면 남는 건 이 저장소가 템플릿
              지문으로 보고 걷어낸 영어 eyebrow 다). --fg-muted 는 12px 이라 4.5 가 필요한데
              종이 위 6.39 / 다크 7.53 이고, 테두리도 같은 색이라 3:1 위다. */}
