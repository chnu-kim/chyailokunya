...
| [0009](./0009-actions-gate-workers-builds.md)        | CI 게이트 = GitHub Actions (배포는 0016 이 대체)                    | Accepted |
...
| [0017](./0017-authjs-chzzk-provider-edge-env.md)     | 인증 라이브러리 = Auth.js(next-auth v5) + 커스텀 치지직 provider    | Accepted |
