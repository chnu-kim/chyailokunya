...
--> statement-breakpoint
INSERT INTO `__new_oauth_accounts`("id", "user_id", "provider", "provider_user_id", "channel_name", "created_at", "last_updated_at") SELECT "id", "user_id", "provider", "provider_user_id", "channel_name", "created_at", "last_updated_at" FROM `oauth_accounts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_refresh_tokens`("id", "user_id", "family_id", "token_hash", "expires_at", "family_expires_at", "superseded_at", "revoked_at", "replaced_by_token", "created_at") SELECT "id", "user_id", "family_id", "token_hash", "expires_at", "family_expires_at", "superseded_at", "revoked_at", "replaced_by_token", "created_at" FROM `refresh_tokens`;--> statement-breakpoint
